...
export function PasswordPreview({ password }) {

    function copyToClipBoard() {
        if ('clipboard' in navigator) {
            navigator.clipboard.writeText(password.outCome)
            showSuccessMsg('Password has been saved')
        } else {
            /// in most case we will dont need this (for old devices)
            document.execCommand('copy', true, password.outCome)
            showSuccessMsg('Password has been saved')
        }
    }
